...
function loggerPluginFn(fastify: FastifyInstance, options: ILoggerPluginOptions): void {
    ...
    const { req: reqSerializer = defaultReqSerializer, res: resSerializer = defaultResSerializer } =
        reqResSerializers ?? {};
